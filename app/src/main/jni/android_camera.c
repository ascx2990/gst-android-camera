...
app_function (void *userdata)
{
  ...
  ahc->ahcsrc = gst_element_factory_make ("ahc2src", NULL);
  ...
  caps = gst_caps_from_string ("video/x-raw,format=NV12,width=640,height=480");
...
JNI_OnLoad (JavaVM * vm, void *reserved)
{
   ...
   *
   *  setenv ("GST_DEBUG", "*:4,ahc:5,camera-test:5,ahc2src:5", 1);
   *  setenv ("GST_DEBUG_NO_COLOR", "1", 1);
   */
  setenv ("GST_DEBUG", "basesrc:3,camera-test:5,ahc2src:5", 1);
  setenv ("GST_DEBUG_NO_COLOR", "1", 1);
